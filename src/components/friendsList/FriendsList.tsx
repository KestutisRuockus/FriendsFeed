    ...
    >
      ...
      >
        ...
        <i
          ...
          className={`fa-solid ${collapsedFriendList ? 'fa-up-right-and-down-left-from-center' : 'fa-down-left-and-up-right-to-center'} 
          font-bold text-xl text-primary cursor-pointer hover:opacity-50 transition-opacity duration-300`}
        />

        {collapsedFriendList && (
          <h1
            className={`font-bold text-xl text-primary ${screenWidth >= 768 ? 'rotate-90' : ''} text-nowrap`}
          >
            Friends List
          </h1>
        )}
      ...
      {!collapsedFriendList && (
        <>
          ...
          <div className={`${screenWidth < 768 ? 'h-[300px]' : 'h-[90vh]'} overflow-hidden overflow-y-scroll`}>
            <Friend />
            <Friend />
            <Friend />
            <Friend />
