  ...
  return (
    ...
    >
        <div className="flex flex-col-reverse sm:flex-row justify-between py-4 px-8 lg:px-16 max-lg:pr-0">
            <h1 className="w-full md:w-2/3 font-bold text-lg pt-4">{post.title}</h1>
            <div
        ...
        <div className="px-4">
            <img src={post.imageURL ? post.imageURL : ''} alt="random" className='m-auto w-full max-w-[600px]'/>
        </div>
        <div className="py-4 px-8 lg:py-8 lg:px-16">
            ...
            <div className="my-6 flex gap-6">
                <div className="flex gap-1 items-center">
                    <p className="text-primary font-bold">Likes: <span>{post.like}</span></p> 
                ...
                <div className="flex gap-1 items-center">
                    <p className="text-primary font-bold">Dislikes: <span>{post.dislike}</span></p> 
