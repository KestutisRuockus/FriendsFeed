...
const Profile = () => {
  ...
  const handleBirthdateInput = (e: React.ChangeEvent<HTMLInputElement>) => setUserDetails({...userDetails, birthdate: e.target.value});
  const handleLocationInput = (e: React.ChangeEvent<HTMLInputElement>) => setUserDetails({...userDetails, location: e.target.value});
  const handleGenderCheckbox = (e: React.ChangeEvent<HTMLInputElement>) => setUserDetails({...userDetails, gender: e.target.value});
  ...
  const handleProfileUpdate = (e: { preventDefault: () => void; }) => {
    ...
    const allInputFields = Object.values(userDetails).every((value) => value !== '');
